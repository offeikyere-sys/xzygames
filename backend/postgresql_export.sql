...
Reboot in the normal, secure mode', '', '', '', '');
...
Get files organized in different formats', '', '', '', '', '', '', '');
...
Repack uses XTool library by Razor12911
At least 4 GB of free RAM (inc. virtual) required for installing this repack
Run the game from one of the desktop icons creadted by the installer', '', '', '', '', '', '', '');
...
Run inZOI.exe to start the game.', '');
...
Repack uses XTool library by Razor12911
At least 2 GB of free RAM (inc. virtual) required for installing this repa', '', '', '', '', '', '', '');
...
At least 2 GB of free RAM (inc. virtual) required for installing this repack
Game language can be changed in game settings, speech and texts separately', '', '', '', '', '', '', '');
INSERT INTO games (id, title, genre, rating, downloads, description, wallpaper_url, download_url, download_links, trailer_url, screenshots, os, processor, memory, graphics, storage, install_guide, color, is_new, type, developer, version, license_type, created_at, repack_features, download_manager_name, download_manager_url, usage_guide, troubleshooting, hypervisor_video_url, install_guide_text, install_video_url) VALUES (67, '3uTools 9.06.006', 'Utilities & System', 4.5, 0, '3uTools is a program that allows you to manage your iOS device on Windows easily. You can easily manage your photo gallery, videos, audio, installed apps, ringtones, etc. You can even quickly check your device''s status, seeing if it has a jailbreak or a bad battery. All the information you need about your iPhone or iPad is at your fingertips.
...
-- Export Tokens
INSERT INTO tokens (id, user_id, token, created_at) VALUES (9, 1, 'db0d0965f3b0f148f44138f25910cc7dfb92f9f4d2f2ecdde170e7c663569689', '2026-06-16 14:31:32');
INSERT INTO tokens (id, user_id, token, created_at) VALUES (18, 2, 'f609fa4777f815702443886b44895ff20dbda805b2d704e6b09e4e5a4a0de523', '2026-06-20 14:59:51');

-- Export Activity Log
INSERT INTO activity_log (id, user_id, user_name, action, item_type, item_name, item_id, created_at) VALUES (1, NULL, 'Guest', 'viewed', 'game', 'Marvel’s Spider-Man: Miles Morales', 59, '2026-06-21 22:05:20');
INSERT INTO activity_log (id, user_id, user_name, action, item_type, item_name, item_id, created_at) VALUES (2, NULL, 'Guest', 'viewed', 'game', 'Marvel’s Spider-Man: Miles Morales', 59, '2026-06-21 22:05:20');
INSERT INTO activity_log (id, user_id, user_name, action, item_type, item_name, item_id, created_at) VALUES (3, NULL, 'Guest', 'viewed', 'movie', 'Ocean''s Quest', 3, '2026-06-21 22:10:42');
INSERT INTO activity_log (id, user_id, user_name, action, item_type, item_name, item_id, created_at) VALUES (4, NULL, 'Guest', 'viewed', 'movie', 'Ocean''s Quest', 3, '2026-06-21 22:10:42');
INSERT INTO activity_log (id, user_id, user_name, action, item_type, item_name, item_id, created_at) VALUES (5, NULL, 'Guest', 'viewed', 'game', 'Internet Download Manager (IDM) 6.42.64', 37, '2026-06-21 22:12:37');
