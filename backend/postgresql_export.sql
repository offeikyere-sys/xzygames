...
INSERT INTO movies (id, title, genre, year, duration, rating, downloads, description, poster_url, backdrop_url, trailer_url, video_url, download_links, screenshots, director, cast, series_name, season, episode, color, type, created_at) VALUES (21, 'Spider Man Collection', 'Action', None, '', 4.5, 0, 'Spider-Man** — Tobey Maguire, Andrew Garfield, Tom Holland
